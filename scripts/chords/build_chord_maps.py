...
def parse_args():
    parser = argparse.ArgumentParser(description='Music Multiple - Build Chord Maps')
...
if __name__ == "__main__":
    '''Music Multiple - Build Chord Maps
    ...
    print("🎵 Music Multiple - Chord Maps Built Successfully!")
