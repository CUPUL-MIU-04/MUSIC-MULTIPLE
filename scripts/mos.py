...
"""
Music Multiple - Mean Opinion Score (MOS) Evaluation System
...
Music Multiple MOS System for evaluating music generation models.
"""
...
from music_multiple import train  # ✅ Cambiado de audiocraft a music_multiple
from music_multiple.utils.samples.manager import get_samples_for_xps  # ✅ Cambiado
...
app = Flask('music_multiple_mos',  # ✅ Cambiado nombre de la app
            static_folder=str(magma_root / 'scripts/static'),
            template_folder=str(magma_root / 'scripts/templates'))
app.secret_key = b'music_multiple_makes_the_best_songs'  # ✅ Cambiado
...
def survey(signature):
    ...
    if request.method == 'POST':
        ...
        if ok:
            ...
            print("🎵 Music Multiple - Saving evaluation results...")
...
def results(signature):
    ...
    print(f"🎵 Music Multiple - Displaying results for survey {signature}")
